...
export default function helmet(set: Set) {
    ...
    set.headers[ 'Strict-Transport-Security' ] = `max-age=${helmetConfig.hsts.maxAge}; includeSubDomains; preload`;
    ...
    set.headers[ 'X-Permitted-Cross-Domain-Policies' ] = helmetConfig.permittedCrossDomainPolicies.permittedPolicies;
